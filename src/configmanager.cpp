...
bool ConfigManager::load()
{
	...
	boolean[HEALTH_REGEN_NOTIFICATION] = getGlobalBoolean(L, "healthRegenNotification", true);
	boolean[MANA_REGEN_NOTIFICATION] = getGlobalBoolean(L, "manaRegenNotification", true);
	boolean[MANA_SPENT_NOTIFICATION] = getGlobalBoolean(L, "manaSpentNotifications", true);
