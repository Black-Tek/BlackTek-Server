local hiveGateHorizontal = ItemEvent()

hiveGateHorizontal.onUse = function(player, item, fromPosition, target, toPosition, isHotkey)
...
local hiveGateVertical = ItemEvent()

hiveGateVertical.onUse = function(player, item, fromPosition, target, toPosition, isHotkey)
	local position = player:getPosition()
