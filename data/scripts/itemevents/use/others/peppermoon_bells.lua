...
local peppermoonFlower = ItemEvent()

peppermoonFlower.onUse = function(player, item, fromPosition, target, toPosition, isHotkey)
...
peppermoonFlower:id(23459, 23461)
peppermoonFlower:register()
