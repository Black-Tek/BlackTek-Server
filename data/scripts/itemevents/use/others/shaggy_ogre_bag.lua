...
local shaggyOgreBag = ItemEvent()

shaggyOgreBag.onUse = function(player, item, fromPosition, target, toPosition, isHotkey)
...
shaggyOgreBag:id(25419)
shaggyOgreBag:register()
