...
local belongingsOfADeceased = ItemEvent()

belongingsOfADeceased.onUse = function(player, item, fromPosition, target, toPosition, isHotkey)
...
belongingsOfADeceased:id(13670)
belongingsOfADeceased:register()
