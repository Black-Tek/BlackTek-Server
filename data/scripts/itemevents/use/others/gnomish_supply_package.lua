...
local gnomishSupplyPackage = ItemEvent()

gnomishSupplyPackage.onUse = function(player, item, fromPosition, target, toPosition, isHotkey)
...
gnomishSupplyPackage:id(18215)
gnomishSupplyPackage:register()
