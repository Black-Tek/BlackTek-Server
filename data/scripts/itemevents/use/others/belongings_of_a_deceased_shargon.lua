...
local belongingsOfADeceasedShargon = ItemEvent()

belongingsOfADeceasedShargon.onUse = function(player, item, fromPosition, target, toPosition, isHotkey)
...
belongingsOfADeceasedShargon:id(23705)
belongingsOfADeceasedShargon:register()
