...
local belongingsOfADeceasedRavager = ItemEvent()

belongingsOfADeceasedRavager.onUse = function(player, item, fromPosition, target, toPosition, isHotkey)
...
belongingsOfADeceasedRavager:id(23704)
belongingsOfADeceasedRavager:register()
