local firebug = ItemEvent()

firebug.onUse = function(player, item, fromPosition, target, toPosition, isHotkey)
	...
	elseif chance == 1 then -- It explodes on the user 1% chance
		doTargetCombat(0, player, Combat.DamageType.Fire, -5, -5, CONST_ME_HITBYFIRE)
