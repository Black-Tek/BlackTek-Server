...
local wallMirror = ItemEvent()

wallMirror.onUse = function(player, item, fromPosition, target, toPosition, isHotkey)
...
for id = 1816, 1817 do wallMirror:id(id) end
for id = 1843, 1844 do wallMirror:id(id) end
for id = 1846, 1847 do wallMirror:id(id) end
for id = 1849, 1850 do wallMirror:id(id) end
wallMirror:register()
