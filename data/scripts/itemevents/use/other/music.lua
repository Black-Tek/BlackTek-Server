...
local musicalInstrument = ItemEvent()

musicalInstrument.onUse = function(player, item, fromPosition, target, toPosition, isHotkey)
...
for id = 2070, 2085 do musicalInstrument:id(id) end
musicalInstrument:id(2332)
musicalInstrument:id(2364)
for id = 2367, 2373 do musicalInstrument:id(id) end
for id = 3951, 3953 do musicalInstrument:id(id) end
musicalInstrument:id(3957)
musicalInstrument:id(5786)
for id = 6572, 6573 do musicalInstrument:id(id) end
musicalInstrument:id(13759)
musicalInstrument:id(23923)
musicalInstrument:register()
