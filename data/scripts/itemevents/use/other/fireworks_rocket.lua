local fireworksRocket = ItemEvent()

fireworksRocket.onUse = function(player, item, fromPosition, target, toPosition, isHotkey)
	if fromPosition.x ~= CONTAINER_POSITION then
		...
		doTargetCombat(0, player, Combat.DamageType.Physical, -10, -10, CONST_ME_EXPLOSIONAREA)
	end
