...
local constructionKit = ItemEvent()

constructionKit.onUse = function(player, item, fromPosition, target, toPosition, isHotkey)
...
for id = 3901, 3938 do constructionKit:id(id) end
for id = 5086, 5088 do constructionKit:id(id) end
constructionKit:id(6114)
constructionKit:id(6115)
constructionKit:id(6372)
constructionKit:id(6373)
constructionKit:id(8692)
constructionKit:id(9974)
constructionKit:id(11124)
constructionKit:id(11126)
constructionKit:id(11133)
constructionKit:id(11205)
constructionKit:id(14328)
constructionKit:id(14329)
constructionKit:id(16075)
constructionKit:id(16099)
constructionKit:id(20254)
constructionKit:id(20255)
constructionKit:id(20257)
