...
local fluidContainer = ItemEvent()

fluidContainer.onUse = function(player, item, fromPosition, target, toPosition, isHotkey)
...
fluidContainer:id(1775)
for id = 2005, 2009 do fluidContainer:id(id) end
for id = 2011, 2015 do fluidContainer:id(id) end
fluidContainer:id(2023)
for id = 2031, 2034 do fluidContainer:id(id) end
for id = 2574, 2577 do fluidContainer:id(id) end
fluidContainer:id(5553)
fluidContainer:register()
