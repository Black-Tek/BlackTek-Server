...
local bedModificationKit = ItemEvent()

bedModificationKit.onUse = function(player, item, fromPosition, target, toPosition, isHotkey)
...
for id = 7904, 7907 do bedModificationKit:id(id) end
bedModificationKit:id(20252)
bedModificationKit:register()
