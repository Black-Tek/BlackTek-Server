...
local teleport_creature_here = TalkAction("/c")
function teleport_creature_here.onSay(player, words, param)
    return onSay(player, words, param)
end
teleport_creature_here:separator(" ")
teleport_creature_here:register()
