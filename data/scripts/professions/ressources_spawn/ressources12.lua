local spawnTree = GlobalEvent("ressources12")
local itemsList = { 
    {itemId = 26634, quantity = 50},
    {itemId = 26606, quantity = 25},
    {itemId = 26610, quantity = 18},
    {itemId = 26613, quantity = 15},
    {itemId = 26609, quantity = 10},
...
STARTUP[#STARTUP + 1] = { 
    action = function()
        local fromPos = {x= 32281, y=32286, z=7}
        local toPos = {x = 32423, y = 32393, z = 7}
