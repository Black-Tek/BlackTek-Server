local spawnTree = GlobalEvent("ressources10")
local itemsList = { 
    {itemId = 26634, quantity = 30},
    {itemId = 26606, quantity = 15},
    {itemId = 26610, quantity = 10},
...
STARTUP[#STARTUP + 1] = { 
    action = function()
        local fromPos = {x= 32851, y=32521, z=7}
        local toPos = {x = 33005, y = 32593, z = 7}
