local spawnTree = GlobalEvent("ressources2")
local itemsList = { 
    {itemId = 26634, quantity = 35},
    {itemId = 26606, quantity = 30},
...
STARTUP[#STARTUP + 1] = { 
    action = function()
        local fromPos = {x= 32468, y=31973, z=7}
        local toPos = {x = 32634, y = 32048, z = 7}
