local spawnTree = GlobalEvent("ressources3")
local itemsList = { 
    {itemId = 26634, quantity = 50},
    {itemId = 26606, quantity = 35},
    {itemId = 26610, quantity = 15},
...
STARTUP[#STARTUP + 1] = { 
    action = function()
        local fromPos = {x= 32620, y=32159, z=7}
        local toPos = {x = 32818, y = 32324, z = 7}
