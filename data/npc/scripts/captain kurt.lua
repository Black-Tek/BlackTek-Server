...
keywordHandler:addKeyword({'sail'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Mordragor}, {Falanaar}, {Death Valley}, {Freewind}, {Kilmaresh}, {Bounac} or {Arkeron}?'})
