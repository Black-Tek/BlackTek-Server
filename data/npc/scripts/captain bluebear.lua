...
keywordHandler:addKeyword({'sail'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Falanaar}, {Dolwatha}, {Death Valley}, {Freewind}, {Kilmaresh}, {Bounac} or {Arkeron}?'})
