...
keywordHandler:addKeyword({'sail'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Mordragor}, {Falanaar}, {Dolwatha}, {Death Valley}, {Kilmaresh}, {Bounac} or {Arkeron}?'})
